...
import pro.dbro.ble.transport.ble.BLECentral;
import pro.dbro.ble.transport.ble.BLEPeripheral;
        ...
        if (mUserIdentity == null) {
            Util.showWelcomeDialog(this, new DialogInterface.OnDismissListener() {
                ...
                public void onDismiss(DialogInterface dialogInterface) {
                    mUserIdentity = ChatApp.getPrimaryLocalPeer(DebugActivity.this);
                }
            });
        }
    }

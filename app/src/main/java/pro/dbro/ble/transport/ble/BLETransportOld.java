...
//    private BLETransportCallback mClientCallback;
...
//
//    public BLETransportOld(@NonNull Context context, @NonNull Peer user) {
//        mContext = context;
//        mUser = user;
//        init();
//        startBleServices();
...
//    }
//
//    public void setMeshCallback(BLETransportCallback cb) {
//        mClientCallback = cb;
//    }
//
//    public void stop() {
...
//                else if (characteristic.getUuid().equals(GATT.IDENTITY_READ_UUID)) {
//                    responseData = ChatApp.getPrimaryLoaclPeerIdentityResponse(mContext);
